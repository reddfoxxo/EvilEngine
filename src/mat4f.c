...
void mat4f_make_orthographic(mat4f_t* m, float angle, float aspect, float z_near, float z_far)
{
	// i know this is sloppy and only works for like this specific camera but i'm kinda short on time and it does work
	/*
	if (angle == 0.0f)
	{
		return;
